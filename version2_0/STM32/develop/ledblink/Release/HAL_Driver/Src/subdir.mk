...
HAL_Driver/Src/%.o: ../HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -mfloat-abi=soft -DSTM32 -DSTM32F1 -DSTM32F103C8Tx -DSTM32F103xB -DUSE_HAL_DRIVER -I"/media/data/D/Dropbox/shared/Tobias-tmbscience/STM32/projects/ledblink/HAL_Driver/Inc/Legacy" -I"/media/data/D/Dropbox/shared/Tobias-tmbscience/STM32/projects/ledblink/inc" -I"/media/data/D/Dropbox/shared/Tobias-tmbscience/STM32/projects/ledblink/CMSIS/device" -I"/media/data/D/Dropbox/shared/Tobias-tmbscience/STM32/projects/ledblink/CMSIS/core" -I"/media/data/D/Dropbox/shared/Tobias-tmbscience/STM32/projects/ledblink/HAL_Driver/Inc" -O3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
