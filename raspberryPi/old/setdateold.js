...
var rtc = new RTCPi();       // realtime clock

// create a new javascript date object
//var d = new Date(2019, 01, 04, 10, 14, 00, 00);
//console.log(d);
...
console.log('UTC  : '+rtc.readDate().toISOString());

//console.log(rtc.readDate().toLocaleDateString());;

var d = new Date(cd.getTime() - cd.getTimezoneOffset() * 60000)
var ld = d.toISOString().slice(0,19); 
